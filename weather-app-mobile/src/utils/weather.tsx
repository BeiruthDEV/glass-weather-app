...
// Importando os ícones da versão mobile
import { Cloud, Sun, Moon, CloudRain, CloudSnow, CloudLightning, CloudMoon, CloudFog } from 'lucide-react-native';

// 1. CORES DO TEMA (GRADIENTES)
// Retorna um array de strings com as cores hexadecimais
...
// Mapeamento detalhado dos códigos WMO
switch (code) {
    case 0:
        return {
...
// Aceita apenas 'C' ou 'F' como unidade
...
// Retorna um objeto com valor numérico e unidade string
