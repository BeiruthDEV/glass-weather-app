...
export const getWeatherTheme = (code, isDay = 1) => {
    ...
    if (isDay === 0) {
        ...
        return ['#111827', '#312E81', '#000000']; // Padrão
    }
...
export const getWeatherInfo = (code, isDay = 1) => {
    ...
    const icons = {
        ...
        fog: <Cloud color={iconColor} size={iconSize} style={{ opacity: 0.7 }} />, // Simulando nevoeiro
    };
